...
- There are many different ways of indexing the same piece of a data frame
  - Each vector below contains 81 entries.  For display purposes, the settings have been adjusted so that only the first 22 are shown below
```{r, eval = FALSE}
...
```{r}
ss<-subset(survey, select=c("OperatingSystem", "TVhours"),  subset=(Program == "PPM" | Program == "Other") & Rexperience == "Basic competence")
```
